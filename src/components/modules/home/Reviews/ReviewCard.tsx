  ...
  return (
    <div className="flex flex-col md:flex-row gap-8">
      ...
      <div className="text-center md:text-left">
        ...
        <blockquote className="relative pl-8 md:pl-12 pr-8 text-gray-700 mb-9 min-h-[4rem]">
          <ImQuotesLeft className="absolute top-0 left-0 text-xl md:text-3xl text-green-200 opacity-80 -translate-y-1 md:-translate-y-2" />
          <p className="relative z-10  md:text-lg ">{review.comment}</p>
